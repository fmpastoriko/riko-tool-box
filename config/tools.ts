...
export const TOOLS_CONFIG: ToolConfig[] = [
  {
    ...
    shortDescription: "Chat with a local or hosted LLM.",
  ...
  },
  {
    ...
    shortDescription: "Join code files, prepend a prompt, ship to any LLM.",
  ...
  },
  {
    ...
    shortDescription: "Apply zip file contents directly to a local repo.",
  ...
  },
  {
    ...
    shortDescription: "Myers diff with inline character highlighting.",
  ...
  },
  {
    ...
    shortDescription: "Generate printable arithmetic crossword puzzles as PDF.",
