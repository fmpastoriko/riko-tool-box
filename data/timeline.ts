...
export const timelineData: TimelineEntry[] = [
  {
    ...
    company: "CV Graffiko",
    problem:
      "Publishing decisions for regional curriculum books were based mostly on intuition rather than structured market analysis.",
    whatIBuilt:
    ...
    impact: [
      "Replaced intuition-based publishing decisions with a structured analytics workflow",
  ...
  },
  {
    ...
    problem:
      "Students struggle with Systems of Linear Equations because existing learning websites do not effectively support higher-order thinking or improved learning outcomes.",
    whatIBuilt:
  ...
  },
  {
    ...
    impactSummary:
      "Identified growth opportunities and established Zenbot's first structured trial performance framework.",
    impact: [
  ...
  },
  {
    ...
    impactSummary: "Reduced telesales operational costs by 20-30% per month.",
    impact: [
    ...
    note: "I can't provide more screenshots because I don't have access to those online services anymore.",
  },
  {
    id: 5,
    type: "SWE",
    ...
    impact: [
      "Report generation time: 15 minutes to under 3 seconds (300x faster)",
  ...
  },
  {
    ...
    company: "Moladin",
    problem:
      "The existing credit scoring workflow needed improvements to support new data sources.",
    whatIBuilt:
    ...
    impactSummary:
      "Extended the credit scoring tool to handle new XML data sources and produce structured Excel + BigQuery outputs.",
    impact: [
  ...
  },
  {
    ...
    impactSummary:
      "Reduced ad-hoc analyst requests by enabling non-technical teams to self-serve flexible datasets.",
    impact: [
  ...
  },
  {
    ...
    impactSummary:
      "Delivered the LMS platform that made the NPMJ competition possible at national scale.",
    impact: [
  ...
  },
  {
    ...
    impactSummary:
      "Replaced manual bookkeeping with a structured automated management system.",
    impact: [
  ...
  },
  {
    ...
    impactSummary:
      "Fully automated document generation across appraisal, credit analyst, and legal teams.",
    impact: [
      "Eliminated manual document preparation across three teams",
      "Documents now generated automatically on Kafka event",
  ...
  },
  {
    ...
    architecture: ["Frontend: Vue", "Backend: Node.js", "Database: PostgreSQL"],
    impactSummary:
      "Delivered a nationwide LMS platform for the Dancow Indonesia Cerdas competition.",
    impact: [
  ...
  },
  {
    ...
    impactSummary:
      "Built a proper internal web app to replace Apps Script limitations.",
    impact: [
